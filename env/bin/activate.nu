...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/admin/Desktop/PROJECTS/flask_docker_kubernetes_mongodb/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/admin/Desktop/PROJECTS/flask_docker_kubernetes_mongodb/env/bin/deactivate.nu'
